...
export function MessageComposer({
  ...
  return (
    <div className="shrink-0 px-4 pb-4">
      ...
      <div className="bg-elevated relative flex items-end gap-2 rounded-xl px-4 py-2">
        {/* File upload button */}
        <button className="text-text-secondary hover:text-text-primary mb-0.5 shrink-0 p-1 transition-colors">
        ...
        <div className="relative shrink-0">
          <button
            ...
            className="text-text-secondary hover:text-text-primary mb-0.5 p-1 transition-colors"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
        ...
        <button
          ...
          className="bg-accent hover:bg-accent-hover mb-0.5 shrink-0 rounded-lg p-1.5 text-white transition-colors disabled:opacity-30"
        >
          <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
